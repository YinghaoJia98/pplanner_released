...
bool Graph::findDijkstraShortestPathsWithGlobalId(int src_id, ShortestPathsReport &rep)
{
  rep.source_id = src_id;
  rep.status = false;
...
int Graph::get_id_global(int IdInternal)
{
  return vertex_internal_id_[IdInternal];
}

int Graph::get_id_internal(int IdGlobal)
{
